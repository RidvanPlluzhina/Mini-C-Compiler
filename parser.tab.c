...
static const char *const yytname[] =
{
  ...
  "INT_TYPE", "FLOAT_TYPE", "IF", "WHILE", "'+'", "'-'", "'*'", "'/'",
  "UMINUS", "';'", "'('", "')'", "'{'", "'}'", "'='", "$accept", "program",
  "stmt", "$@1", "stmt_list", "decl", "assign", "expr", "term", "factor", YY_NULLPTR
};
...
{
     -18,     1,   -18,   -17,    23,    37,    27,    28,   -18,   -18,
      30,    31,     0,   -18,   -18,     0,     0,     6,   -18,   -18,
     -18,   -18,     0,     7,    21,   -18,    10,    12,     6,    29,
      15,     0,     0,     0,     0,     6,     6,   -18,   -18,   -18,
      21,    21,   -18,   -18,   -18,   -18
};
...
{
       3,     0,     1,     0,     0,     0,     0,     0,     8,     2,
       0,     0,     0,    12,    13,     0,     0,    11,     4,     5,
      21,    22,     0,    14,    17,    20,     0,     0,    11,     0,
       0,     0,     0,     0,     0,     0,     0,    10,     9,    23,
      15,    16,    18,    19,     6,     7
};
...
{
     -18,   -18,    -1,   -18,    18,   -18,   -18,    14,     8,     4
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     1,    28,    17,    29,    10,    11,    23,    24,    25
};
...
{
       9,     2,    12,    20,    21,     3,     4,     5,     6,     7,
       3,     4,     5,     6,     7,    22,    31,    32,     8,    31,
      32,    31,    32,     8,    31,    32,    35,    13,    36,    26,
      27,    39,    33,    34,    44,    45,    30,    42,    43,    40,
      41,    14,    15,    16,    18,    19,    37,    38
};

static const yytype_int8 yycheck[] =
{
       1,     0,    19,     3,     4,     4,     5,     6,     7,     8,
       4,     5,     6,     7,     8,    15,     9,    10,    17,     9,
      10,     9,    10,    17,     9,    10,    16,     4,    16,    15,
      16,    16,    11,    12,    35,    36,    22,    33,    34,    31,
      32,     4,    15,    15,    14,    14,    28,    18
};
...
{
       0,    21,     0,     4,     5,     6,     7,     8,    17,    22,
      25,    26,    19,     4,     4,    15,    15,    23,    14,    14,
       3,     4,    15,    27,    28,    29,    27,    27,    22,    24,
      27,     9,    10,    11,    12,    16,    16,    24,    18,    16,
      28,    28,    29,    29,    22,    22
};
